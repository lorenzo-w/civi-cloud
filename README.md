...
- Modules:
  - Set via `DOLI_MODULES` in Docker env
  - Take module names from filenames [here](https://github.com/Dolibarr/dolibarr/tree/develop/htdocs/core/modules) (without `.class.php`)
  - List of apps:
    - [modAccounting](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modAccounting.class.php)
    - [modAgenda](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modAgenda.class.php)
    - [modApi](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modApi.class.php)
    - [modBookmark](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modBookmark.class.php)
    - [modCategorie](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modCategorie.class.php)
    - [modContrat](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modContrat.class.php)
    - [modCron](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modCron.class.php)
    - [modDav](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modDav.class.php)
    - [modDocumentGeneration](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modDocumentGeneration.class.php)
    - [modEventOrganization](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modEventOrganization.class.php)
    - [modExpenseReport](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modExpenseReport.class.php)
    - [modExport](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modExport.class.php)
    - [modFckeditor](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modFckeditor.class.php)
    - [modFournisseur](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modFournisseur.class.php)
    - [modHRM](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modHRM.class.php)
    - [modImport](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modImport.class.php)
    - [modLabel](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modLabel.class.php)
    - [modLdap](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modLdap.class.php)
    - [modLoan](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modLoan.class.php)
    - [modMailing](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modMailing.class.php)
    - [modNotification](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modNotification.class.php)
    - [modOauth](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modOauth.class.php)
    - [modPaymentByBankTransfer](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modPaymentByBankTransfer.class.php)
    - [modPaypal](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modPaypal.class.php)
    - [modPrinting](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modPrinting.class.php)
    - [modProduct](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modProduct.class.php)
    - [modProjet](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modProjet.class.php)
    - [modReceiptPrinter](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modReceiptPrinter.class.php)
    - [modRecruitment](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modRecruitment.class.php)
    - [modResource](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modResource.class.php)
    - [modService](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modService.class.php)
    - [modSocialNetworks](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modSocialNetworks.class.php)
    - [modSociete](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modSociete.class.php)
    - [modTicket](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modTicket.class.php)
    - [modUser](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modUser.class.php)
    - [modTax](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modTax.class.php)
    - [modWebServices](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modWebServices.class.php)
    - [modWorkflow](https://github.com/Dolibarr/dolibarr/blob/develop/htdocs/core/modules/modWorkflow.class.php)
    - External: [cDav](https://github.com/Befox/cdav#how-to-install)
- SSO:
  - via LDAP settings in Docker env
- Clients:
  - [Android app](https://play.google.com/store/apps/details?id=com.nltechno.dolidroidpro&hl=en)
